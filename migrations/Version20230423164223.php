 ...
 */
final class Version20230423164223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE api_data CHANGE name url VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE api_data CHANGE url name VARCHAR(255) DEFAULT NULL');
    }
}
